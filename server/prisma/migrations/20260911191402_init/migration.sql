...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'STATUS_CHANGED', 'TASK_OVERDUE', 'PROJECT_CREATED', 'GENERAL');
...
-- CreateIndex
CREATE INDEX "task_activity_logs_changedAt_idx" ON "task_activity_logs"("changedAt");
...
-- AddForeignKey
ALTER TABLE "task_activity_logs" ADD CONSTRAINT "task_activity_logs_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
